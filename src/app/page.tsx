        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 text-center">
          ...
          >
            <MotionDiv variants={variants}>
              <h1 className="text-4xl font-bold tracking-tighter text-primary sm:text-5xl md:text-7xl lg:text-8xl md:bg-clip-text md:text-transparent md:bg-gradient-to-r md:from-primary md:to-accent">
                Dev-Zahid
              </h1>
            </MotionDiv>
            <MotionDiv variants={variants}>
